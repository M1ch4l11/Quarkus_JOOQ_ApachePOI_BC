...
public class EmployeesRecord extends UpdatableRecordImpl<EmployeesRecord> implements Record8<Integer, String, String, String, String, String, Integer, String> {
     ...
     */
    public EmployeesRecord(Integer employeenumber, String officecode, String lastname, String firstname, String extension, String email, Integer reportsto, String jobtitle) {
        super(Employees.EMPLOYEES);
     ...
     * Create a detached, initialised EmployeesRecord
     */
    public EmployeesRecord(model.company.tables.pojos.Employees value) {
        super(Employees.EMPLOYEES);
        ...
        if (value != null) {
            ...
            setReportsto(value.getReportsto());
            setJobtitle(value.getJobtitle());
            resetChangedOnNotNull();
        }
    }
}
