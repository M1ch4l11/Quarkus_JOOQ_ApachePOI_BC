...
public class ProductlinesRecord extends UpdatableRecordImpl<ProductlinesRecord> implements Record4<String, String, String, byte[]> {
     ...
     * Create a detached, initialised ProductlinesRecord
     */
    public ProductlinesRecord(model.company.tables.pojos.Productlines value) {
        super(Productlines.PRODUCTLINES);

        if (value != null) {
            setProductline(value.getProductline());
            setTextdescription(value.getTextdescription());
            setHtmldescription(value.getHtmldescription());
