 ...
 */
package model.information_schema;
...
import model.information_schema.tables.AdministrableRoleAuthorizations;
import model.information_schema.tables.ApplicableRoles;
import model.information_schema.tables.Attributes;
import model.information_schema.tables.CharacterSets;
import model.information_schema.tables.CheckConstraintRoutineUsage;
import model.information_schema.tables.CheckConstraints;
import model.information_schema.tables.CollationCharacterSetApplicability;
import model.information_schema.tables.Collations;
import model.information_schema.tables.ColumnColumnUsage;
import model.information_schema.tables.ColumnDomainUsage;
import model.information_schema.tables.ColumnOptions;
import model.information_schema.tables.ColumnPrivileges;
import model.information_schema.tables.ColumnUdtUsage;
import model.information_schema.tables.Columns;
import model.information_schema.tables.ConstraintColumnUsage;
import model.information_schema.tables.ConstraintTableUsage;
import model.information_schema.tables.DataTypePrivileges;
import model.information_schema.tables.DomainConstraints;
import model.information_schema.tables.DomainUdtUsage;
import model.information_schema.tables.Domains;
import model.information_schema.tables.ElementTypes;
import model.information_schema.tables.EnabledRoles;
import model.information_schema.tables.ForeignDataWrapperOptions;
import model.information_schema.tables.ForeignDataWrappers;
import model.information_schema.tables.ForeignServerOptions;
import model.information_schema.tables.ForeignServers;
import model.information_schema.tables.ForeignTableOptions;
import model.information_schema.tables.ForeignTables;
import model.information_schema.tables.InformationSchemaCatalogName;
import model.information_schema.tables.KeyColumnUsage;
import model.information_schema.tables.Parameters;
import model.information_schema.tables.ReferentialConstraints;
import model.information_schema.tables.RoleColumnGrants;
import model.information_schema.tables.RoleRoutineGrants;
import model.information_schema.tables.RoleTableGrants;
import model.information_schema.tables.RoleUdtGrants;
import model.information_schema.tables.RoleUsageGrants;
import model.information_schema.tables.RoutineColumnUsage;
import model.information_schema.tables.RoutinePrivileges;
import model.information_schema.tables.RoutineRoutineUsage;
import model.information_schema.tables.RoutineSequenceUsage;
import model.information_schema.tables.RoutineTableUsage;
import model.information_schema.tables.Routines;
import model.information_schema.tables.Schemata;
import model.information_schema.tables.Sequences;
import model.information_schema.tables.SqlFeatures;
import model.information_schema.tables.SqlImplementationInfo;
import model.information_schema.tables.SqlSizing;
import model.information_schema.tables.TableConstraints;
import model.information_schema.tables.TablePrivileges;
import model.information_schema.tables.Tables;
import model.information_schema.tables.TriggeredUpdateColumns;
import model.information_schema.tables.Triggers;
import model.information_schema.tables.UdtPrivileges;
import model.information_schema.tables.UsagePrivileges;
import model.information_schema.tables.UserDefinedTypes;
import model.information_schema.tables.UserMappingOptions;
import model.information_schema.tables.UserMappings;
import model.information_schema.tables.ViewColumnUsage;
import model.information_schema.tables.ViewRoutineUsage;
import model.information_schema.tables.ViewTableUsage;
import model.information_schema.tables.Views;
import model.information_schema.tables._PgExpandarray;
import model.information_schema.tables.records._PgExpandarrayRecord;
...
public class InformationSchema extends SchemaImpl {
    ...
    public static Result<_PgExpandarrayRecord> _PG_EXPANDARRAY(
        ...
        return configuration.dsl().selectFrom(model.information_schema.tables._PgExpandarray._PG_EXPANDARRAY.call(
              __1
        )).fetch();
    }
    ...
    public static _PgExpandarray _PG_EXPANDARRAY(
        ...
        return model.information_schema.tables._PgExpandarray._PG_EXPANDARRAY.call(
            __1
        );
    }
    ...
    public final List<Domain<?>> getDomains() {
        return Arrays.asList(
            model.information_schema.Domains.CARDINAL_NUMBER,
            model.information_schema.Domains.CHARACTER_DATA,
            model.information_schema.Domains.SQL_IDENTIFIER,
            model.information_schema.Domains.TIME_STAMP,
            model.information_schema.Domains.YES_OR_NO
        );
    }
