 ...
 */
package model.information_schema.routines;
...
public class _PgTruetypid extends AbstractRoutine<Long> {
     ...
     */
    public static final Parameter<PgAttributeRecord> _1 = Internal.createParameter("_1", model.pg_catalog.tables.PgAttribute.PG_ATTRIBUTE.getDataType(), false, true);

    /**
     * The parameter <code>information_schema._pg_truetypid._2</code>.
     */
    public static final Parameter<PgTypeRecord> _2 = Internal.createParameter("_2", model.pg_catalog.tables.PgType.PG_TYPE.getDataType(), false, true);
