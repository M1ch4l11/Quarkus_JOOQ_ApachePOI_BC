...
import model.information_schema.tables.records.ColumnOptionsRecord;
...
public class ColumnOptions extends TableImpl<ColumnOptionsRecord> {
     ...
     */
    public final TableField<ColumnOptionsRecord, String> TABLE_CATALOG = createField(DSL.name("table_catalog"), model.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.column_options.table_schema</code>.
     */
    public final TableField<ColumnOptionsRecord, String> TABLE_SCHEMA = createField(DSL.name("table_schema"), model.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.column_options.table_name</code>.
     */
    public final TableField<ColumnOptionsRecord, String> TABLE_NAME = createField(DSL.name("table_name"), model.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.column_options.column_name</code>.
     */
    public final TableField<ColumnOptionsRecord, String> COLUMN_NAME = createField(DSL.name("column_name"), model.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.column_options.option_name</code>.
     */
    public final TableField<ColumnOptionsRecord, String> OPTION_NAME = createField(DSL.name("option_name"), model.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.column_options.option_value</code>.
     */
    public final TableField<ColumnOptionsRecord, String> OPTION_VALUE = createField(DSL.name("option_value"), model.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");
