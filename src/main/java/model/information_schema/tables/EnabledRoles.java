...
import model.information_schema.tables.records.EnabledRolesRecord;
...
public class EnabledRoles extends TableImpl<EnabledRolesRecord> {
     ...
     */
    public final TableField<EnabledRolesRecord, String> ROLE_NAME = createField(DSL.name("role_name"), model.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");
