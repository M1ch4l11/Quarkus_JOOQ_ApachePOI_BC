...
import model.information_schema.tables.records.InformationSchemaCatalogNameRecord;
...
public class InformationSchemaCatalogName extends TableImpl<InformationSchemaCatalogNameRecord> {
     ...
     */
    public final TableField<InformationSchemaCatalogNameRecord, String> CATALOG_NAME = createField(DSL.name("catalog_name"), model.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");
