...
import model.information_schema.tables.records.SqlImplementationInfoRecord;
...
public class SqlImplementationInfo extends TableImpl<SqlImplementationInfoRecord> {
     ...
     */
    public final TableField<SqlImplementationInfoRecord, String> IMPLEMENTATION_INFO_ID = createField(DSL.name("implementation_info_id"), model.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.sql_implementation_info.implementation_info_name</code>.
     */
    public final TableField<SqlImplementationInfoRecord, String> IMPLEMENTATION_INFO_NAME = createField(DSL.name("implementation_info_name"), model.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.sql_implementation_info.integer_value</code>.
     */
    public final TableField<SqlImplementationInfoRecord, Integer> INTEGER_VALUE = createField(DSL.name("integer_value"), model.information_schema.Domains.CARDINAL_NUMBER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.sql_implementation_info.character_value</code>.
     */
    public final TableField<SqlImplementationInfoRecord, String> CHARACTER_VALUE = createField(DSL.name("character_value"), model.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.sql_implementation_info.comments</code>.
     */
    public final TableField<SqlImplementationInfoRecord, String> COMMENTS = createField(DSL.name("comments"), model.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");
