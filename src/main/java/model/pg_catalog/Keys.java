...
import model.pg_catalog.tables.records.PgAggregateRecord;
import model.pg_catalog.tables.records.PgAmRecord;
import model.pg_catalog.tables.records.PgAmopRecord;
import model.pg_catalog.tables.records.PgAmprocRecord;
import model.pg_catalog.tables.records.PgAttrdefRecord;
import model.pg_catalog.tables.records.PgAttributeRecord;
import model.pg_catalog.tables.records.PgAuthMembersRecord;
import model.pg_catalog.tables.records.PgCastRecord;
import model.pg_catalog.tables.records.PgClassRecord;
import model.pg_catalog.tables.records.PgCollationRecord;
import model.pg_catalog.tables.records.PgConstraintRecord;
import model.pg_catalog.tables.records.PgConversionRecord;
import model.pg_catalog.tables.records.PgDatabaseRecord;
import model.pg_catalog.tables.records.PgDbRoleSettingRecord;
import model.pg_catalog.tables.records.PgDefaultAclRecord;
import model.pg_catalog.tables.records.PgDescriptionRecord;
import model.pg_catalog.tables.records.PgEnumRecord;
import model.pg_catalog.tables.records.PgEventTriggerRecord;
import model.pg_catalog.tables.records.PgExtensionRecord;
import model.pg_catalog.tables.records.PgForeignDataWrapperRecord;
import model.pg_catalog.tables.records.PgForeignServerRecord;
import model.pg_catalog.tables.records.PgForeignTableRecord;
import model.pg_catalog.tables.records.PgIndexRecord;
import model.pg_catalog.tables.records.PgInheritsRecord;
import model.pg_catalog.tables.records.PgInitPrivsRecord;
import model.pg_catalog.tables.records.PgLanguageRecord;
import model.pg_catalog.tables.records.PgLargeobjectMetadataRecord;
import model.pg_catalog.tables.records.PgNamespaceRecord;
import model.pg_catalog.tables.records.PgOpclassRecord;
import model.pg_catalog.tables.records.PgOperatorRecord;
import model.pg_catalog.tables.records.PgOpfamilyRecord;
import model.pg_catalog.tables.records.PgPartitionedTableRecord;
import model.pg_catalog.tables.records.PgPolicyRecord;
import model.pg_catalog.tables.records.PgProcRecord;
import model.pg_catalog.tables.records.PgPublicationRecord;
import model.pg_catalog.tables.records.PgPublicationRelRecord;
import model.pg_catalog.tables.records.PgRangeRecord;
import model.pg_catalog.tables.records.PgReplicationOriginRecord;
import model.pg_catalog.tables.records.PgRewriteRecord;
import model.pg_catalog.tables.records.PgSeclabelRecord;
import model.pg_catalog.tables.records.PgSequenceRecord;
import model.pg_catalog.tables.records.PgShdescriptionRecord;
import model.pg_catalog.tables.records.PgShseclabelRecord;
import model.pg_catalog.tables.records.PgStatisticExtRecord;
import model.pg_catalog.tables.records.PgSubscriptionRecord;
import model.pg_catalog.tables.records.PgSubscriptionRelRecord;
import model.pg_catalog.tables.records.PgTablespaceRecord;
import model.pg_catalog.tables.records.PgTransformRecord;
import model.pg_catalog.tables.records.PgTriggerRecord;
import model.pg_catalog.tables.records.PgTsConfigMapRecord;
import model.pg_catalog.tables.records.PgTsConfigRecord;
import model.pg_catalog.tables.records.PgTsDictRecord;
import model.pg_catalog.tables.records.PgTsParserRecord;
import model.pg_catalog.tables.records.PgTsTemplateRecord;
import model.pg_catalog.tables.records.PgTypeRecord;
