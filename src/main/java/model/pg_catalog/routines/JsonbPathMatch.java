...
public class JsonbPathMatch extends AbstractRoutine<Boolean> {
     ...
     */
    public static final Parameter<JSONB> VARS = Internal.createParameter("vars", SQLDataType.JSONB, false, false);

    /**
     * The parameter <code>pg_catalog.jsonb_path_match.silent</code>.
     */
    public static final Parameter<Boolean> SILENT = Internal.createParameter("silent", SQLDataType.BOOLEAN, false, false);
