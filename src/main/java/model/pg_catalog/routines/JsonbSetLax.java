...
public class JsonbSetLax extends AbstractRoutine<JSONB> {
     ...
     */
    public static final Parameter<Boolean> CREATE_IF_MISSING = Internal.createParameter("create_if_missing", SQLDataType.BOOLEAN, false, false);

    /**
     * The parameter <code>pg_catalog.jsonb_set_lax.null_value_treatment</code>.
     */
    public static final Parameter<String> NULL_VALUE_TREATMENT = Internal.createParameter("null_value_treatment", SQLDataType.CLOB, false, false);
