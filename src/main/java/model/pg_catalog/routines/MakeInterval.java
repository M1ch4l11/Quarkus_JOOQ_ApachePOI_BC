...
public class MakeInterval extends AbstractRoutine<YearToSecond> {
     ...
     */
    public static final Parameter<Integer> YEARS = Internal.createParameter("years", SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.make_interval.months</code>.
     */
    public static final Parameter<Integer> MONTHS = Internal.createParameter("months", SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.make_interval.weeks</code>.
     */
    public static final Parameter<Integer> WEEKS = Internal.createParameter("weeks", SQLDataType.INTEGER, false, false);
     ...
     */
    public static final Parameter<Integer> HOURS = Internal.createParameter("hours", SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.make_interval.mins</code>.
     */
    public static final Parameter<Integer> MINS = Internal.createParameter("mins", SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.make_interval.secs</code>.
     */
    public static final Parameter<Double> SECS = Internal.createParameter("secs", SQLDataType.DOUBLE, false, false);
