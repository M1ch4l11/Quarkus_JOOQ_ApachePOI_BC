...
public class PgCollation extends TableImpl<PgCollationRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function10<? super Long, ? super String, ? super Long, ? super Long, ? super String, ? super Boolean, ? super Integer, ? super String, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function10<? super Long, ? super String, ? super Long, ? super Long, ? super String, ? super Boolean, ? super Integer, ? super String, ? super String, ? super String, ? extends U> from) {
