...
public class PgDatabase extends TableImpl<PgDatabaseRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function14<? super Long, ? super String, ? super Long, ? super Integer, ? super String, ? super String, ? super Boolean, ? super Boolean, ? super Integer, ? super Long, ? super Long, ? super Long, ? super Long, ? super String[], ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function14<? super Long, ? super String, ? super Long, ? super Integer, ? super String, ? super String, ? super Boolean, ? super Boolean, ? super Integer, ? super Long, ? super Long, ? super Long, ? super Long, ? super String[], ? extends U> from) {
