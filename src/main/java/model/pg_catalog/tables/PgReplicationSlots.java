...
import model.pg_catalog.tables.records.PgReplicationSlotsRecord;
...
public class PgReplicationSlots extends TableImpl<PgReplicationSlotsRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function15<? super String, ? super String, ? super String, ? super Long, ? super String, ? super Boolean, ? super Boolean, ? super Integer, ? super Long, ? super Long, ? super Object, ? super Object, ? super String, ? super Long, ? super Boolean, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function15<? super String, ? super String, ? super String, ? super Long, ? super String, ? super Boolean, ? super Boolean, ? super Integer, ? super Long, ? super Long, ? super Object, ? super Object, ? super String, ? super Long, ? super Boolean, ? extends U> from) {
