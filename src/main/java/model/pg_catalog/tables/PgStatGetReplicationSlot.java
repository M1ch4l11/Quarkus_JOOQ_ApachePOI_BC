...
public class PgStatGetReplicationSlot extends TableImpl<PgStatGetReplicationSlotRecord> {
    ...
    @Override
    public PgStatGetReplicationSlot as(Table<?> alias) {
        return new PgStatGetReplicationSlot(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public PgStatGetReplicationSlot rename(Table<?> name) {
        return new PgStatGetReplicationSlot(name.getQualifiedName(), null, parameters);
    }
