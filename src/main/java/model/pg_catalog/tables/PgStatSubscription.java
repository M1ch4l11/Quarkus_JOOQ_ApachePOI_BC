...
import model.pg_catalog.tables.records.PgStatSubscriptionRecord;
...
public class PgStatSubscription extends TableImpl<PgStatSubscriptionRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function9<? super Long, ? super String, ? super Integer, ? super Long, ? super Object, ? super OffsetDateTime, ? super OffsetDateTime, ? super Object, ? super OffsetDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function9<? super Long, ? super String, ? super Integer, ? super Long, ? super Object, ? super OffsetDateTime, ? super OffsetDateTime, ? super Object, ? super OffsetDateTime, ? extends U> from) {
