...
import model.pg_catalog.tables.records.PgStatUserIndexesRecord;
...
public class PgStatUserIndexes extends TableImpl<PgStatUserIndexesRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super Long, ? super Long, ? super String, ? super String, ? super String, ? super Long, ? super Long, ? super Long, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super Long, ? super Long, ? super String, ? super String, ? super String, ? super Long, ? super Long, ? super Long, ? extends U> from) {
