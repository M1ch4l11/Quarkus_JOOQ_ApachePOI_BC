...
public class PgSubscriptionRecord extends UpdatableRecordImpl<PgSubscriptionRecord> implements Record10<Long, Long, String, Long, Boolean, Boolean, Boolean, String, String, String[]> {
    ...
    @Override
    public Row10<Long, Long, String, Long, Boolean, Boolean, Boolean, String, String, String[]> valuesRow() {
    ...
    @Override
    public PgSubscriptionRecord values(Long value1, Long value2, String value3, Long value4, Boolean value5, Boolean value6, Boolean value7, String value8, String value9, String[] value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PgSubscriptionRecord(Long oid, Long subdbid, String subname, Long subowner, Boolean subenabled, Boolean subbinary, Boolean substream, String subslotname, String subsynccommit, String[] subpublications) {
        super(PgSubscription.PG_SUBSCRIPTION);
     ...
     * Create a detached, initialised PgSubscriptionRecord
     */
    public PgSubscriptionRecord(model.pg_catalog.tables.pojos.PgSubscription value) {
        super(PgSubscription.PG_SUBSCRIPTION);
